...
- Домен: Управление умным домом
  ...
  - Поддомен: Управление сценариями
    - Контекст: создания сценария пользователем
    - Контекст: изменение сценария для комнат
  - Поддомен: Мониторинг
    - Контекст: Мониторинг температуры
    - Контекст: Мониторинг света
    - Контекст: Мониторинг системы отопления
  - Поддомен: Управление светом
    - Контекст: изменение света всех комнат
    - Контекст: изменение света одной комнаты
  - Поддомен: Управление отоплением
    - Контекст: изменение отопления всех комнат
    - Контекст: изменение отопления одной комнаты
- Домен: Поддержка
  - Поддомен: Администрирование пользователями
    - Контекст: Добавление пользователя
    - Контекст: Удаление пользователя
  - Поддомен: Консультирование
    - Контекст: Консультация по системе
    - Контекст: Консультация по оплате
- Домен: Оплата
  - Поддомен: Управление оплатой
    - Контекст: Оплата системы
  - Поддомен: Отчеты
    - Контекст: Отчет по оплатам системы
- Домен: Маркейтинг
  - Поддомен: Демо-стенд
    - Контекст: Тестовый стенд демонстрации клиенту
- Домен: Управление устройствами
  - Поддомен: Администрирование устройств
    - Контекст: Добавление устройств
